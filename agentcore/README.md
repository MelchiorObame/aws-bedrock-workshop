...
- Evaluate agent performance with online evaluations (20 mins)
- Build a customer-facing web app (20 mins)

## Architecture Overview

By the end of the 7 labs of this tutorial you will have created the following architecture
...
Configure online evaluation to continuously monitor your production agent.
- Built-in evaluators for goal success, correctness, and tool selection
- Real-time quality monitoring through CloudWatch dashboards
- Automated sampling and evaluation of agent interactions
...
### Optional Lab: AgentCore Policy
Add security controls to your agent using Cedar policies.
- Create Policy Engines for fine-grained access control
- Write Cedar policies to restrict tool usage
- Test ALLOW and DENY scenarios with real agent requests

**What you'll learn:** AgentCore Policy for declarative security controls

## Getting Started

1. Clone this repository
2. Install dependencies: `pip install -r requirements-agent.txt`
...
**Lab 5:** Online evaluation with AgentCore Evaluations for quality monitoring
